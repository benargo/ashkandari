...
<html lang="en" dir="ltr">
	<head>
		...
		<!-- Core Stylesheets -->
		<link type="text/css" rel="stylesheet" media="screen and (min-width:640px)" href="/media/css/screen.min.css" />
		<link type="text/css" rel="stylesheet" media="screen and (min-width:0px) and (max-width:639px)" href="/media/css/mobile.css" />
