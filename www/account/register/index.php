...
<form id="form1" action="/account/register/verify" method="post">
	...
	<p>To start with, we need you to enter your email address:</p>
	...
	<p>Now we need you to choose a password:</p>
	<p><input type="password" name="password" autocomplete="no" required="true" /></p>
	
	<p>And if you wouldn't mind, please type that password again for verification purposes:</p>
	<p><input type="password" name="password_verify" autocomplete="no" required="true" /></p>
	
	<p>The final bit of information we need is for you to type the name of your primary character (including any accents):</p>
