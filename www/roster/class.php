...
$class_slug = $_GET['slug'];
$class = getClassBySlug($class_slug);

/* Set the page title */
$page_title = $class->name ." - Guild Roster";
...
if( $roster = $db->query("SELECT `id` FROM `characters` WHERE `class` = ". $class->id ." ORDER BY `rank`, `name`") ) {
