...
if( $character = new character($character_id) ) {
	...
	<tbody>
		<tr>
			...
			<td class="bold"><img src="<?php echo $profession1->getIcon(); ?>" alt="<?php echo $profession1->name; ?> icon" class="icon" /> <?php if($profession1->hasRecipes()) { ?><a href="/roster/character/<?php echo $character->name; ?>/<?php echo strtolower($profession1->name); ?>"><?php } echo $profession1->name; if($profession1->hasRecipes()) echo "</a>"; ?></td>
		...
		<tr>
			...
			<td class="bold"><img src="<?php echo $profession2->getIcon(); ?>" alt="<?php echo $profession2->name; ?> icon" class="icon" /> <?php if($profession2->hasRecipes()) { ?><a href="/roster/character/<?php echo $character->name; ?>/<?php echo strtolower($profession2->name);  ?>"><?php } echo $profession2->name; if($profession1->hasRecipes()) echo "</a>"; ?></td>
		...
		<tr>
			...
			<td class="bold"><img src="<?php echo $cooking->getIcon(); ?>" alt="Cooking icon" class="icon" /> <?php if($cooking->hasRecipes()) { ?><a href="/roster/character/<?php echo $character->name; ?>/cooking"><?php } ?>Cooking<?php if($cooking->hasRecipes()) echo "</a>"; ?></td>
		...
		<section id="alts">
			...
			while($obj = $alts->fetch_object()) {
				...
				?><a href="/roster/character/<?php echo $alt->name; ?>" class="display block clear both">
					...
					<h4 class="bold"><?php echo $alt->name; ?></h4>
